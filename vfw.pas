...
//fix UNICODE Version API By Flying Wang. 2018-05-08
...
const
  ...
  BI_RGB24 = $E436EB7D;
  BI_RGB32 = $E436EB7E;
  BI_ARGB1555  = $297C55AF;
  BI_ARGB4444  = $6E6415E6;
  BI_ARGB32    = $773c9ac0;
  BI_A2R10G10B10 = $2f8bb76d;
  BI_A2B10G10R10 = $576f7893;
  BI_AYUV = $56555941;
  BI_AI44 = $34344941;
  BI_IA44 = $34344149;
...
function    AVIFileOpen(var ppfile: IAVIFile; szFile: LPCTSTR; uMode: UINT; lpHandler: PCLSID): HResult; stdcall; // A or W
...
function    AVIStreamOpenFromFileW(var ppavi: IAVISTREAM; szFile: LPCWSTR; fccType: DWORD;
 ...
 function AVIStreamOpenFromFile(var ppavi: IAVISTREAM; szFile: LPCTSTR; fccType: DWORD;
     lParam: LONG; mode: UINT; pclsidHandler: PCLSID): HResult; stdcall;  // A or W
...
function    AVIBuildFilter(lpszFilter: LPTSTR; cbFilter: LONG; fSaving: BOOL): HResult; stdcall; // A or W
...
function    EditStreamSetInfo(pavi: IAVISTREAM; lpInfo: PAVISTREAMINFO; cbInfo: LONG): HResult; stdcall; // A or w
function    EditStreamSetName(pavi: IAVISTREAM; lpszName: LPCTSTR): HResult; stdcall; // A or W
...
function    MCIWndCreate(hwndParent: HWND; hInstance: HINST; dwStyle: DWORd; szFile: LPCTSTR): HWND; cdecl; // A or W
...
function    GetOpenFileNamePreview(lpofn: POpenFilename): BOOL; stdcall; // A or W
function    GetSaveFileNamePreview(lpofn: POpenFilename): BOOL; stdcall; // A or W
...
function    AVIFileOpen(var ppfile: IAVIFILE; szFile: LPCTSTR; uMode: UINT; lpHandler: PCLSID): HResult; stdcall;  external AVIFILDLL
  name {$IFDEF UNICODE}'AVIFileOpenW'{$ELSE}'AVIFileOpenA'{$ENDIF};
...
function    AVIFileInfo(pfile: IAVIFILE; var pfi: TAVIFILEINFO; lSize: LONG): HResult; stdcall;  external AVIFILDLL
  name {$IFDEF UNICODE}'AVIFileInfoW'{$ELSE}'AVIFileInfoA'{$ENDIF};
...
function    AVIFileCreateStream(pfile: IAVIFILE; var ppavi: IAVISTREAM; var psi: TAVISTREAMINFO): HResult; stdcall; external AVIFILDLL
  name {$IFDEF UNICODE}'AVIFileCreateStreamW'{$ELSE}'AVIFileCreateStreamA'{$ENDIF};
...
function    AVIStreamInfo(pavi: IAVISTREAM; var psi: TAVISTREAMINFO; lSize: LONG): HResult; stdcall; external AVIFILDLL
  name {$IFDEF UNICODE}'AVIStreamInfoW'{$ELSE}'AVIStreamInfoA'{$ENDIF};
...
function AVIStreamOpenFromFile(var ppavi: IAVISTREAM; szFile: LPCTSTR; fccType: DWORD;
  lParam: LONG; mode: UINT; pclsidHandler: PCLSID): HResult; stdcall; external AVIFILDLL
  name {$IFDEF UNICODE}'AVIStreamOpenFromFileW'{$ELSE}'AVIStreamOpenFromFileA'{$ENDIF};
...
function    AVISaveV(
    ...
    var ppavi       : IAVISTREAM;
    var plpOptions  : PAVICOMPRESSOPTIONS
    ): HResult; stdcall; external AVIFILDLL name {$IFDEF UNICODE}'AVISaveVW'{$ELSE}'AVISaveVA'{$ENDIF};
...
function    AVIBuildFilter(lpszFilter: LPTSTR; cbFilter: LONG; fSaving: BOOL): HResult; stdcall; external AVIFILDLL
  name {$IFDEF UNICODE}'AVIBuildFilterW'{$ELSE}'AVIBuildFilterA'{$ENDIF};
...
function    EditStreamSetInfo(pavi: IAVISTREAM; lpInfo: PAVISTREAMINFO; cbInfo: LONG): HResult; stdcall; external AVIFILDLL
  name {$IFDEF UNICODE}'EditStreamSetInfoW'{$ELSE}'EditStreamSetInfoA'{$ENDIF};
function    EditStreamSetName(pavi: IAVISTREAM; lpszName: LPCTSTR): HResult; stdcall; external AVIFILDLL
  name {$IFDEF UNICODE}'EditStreamSetNameW'{$ELSE}'EditStreamSetNameA'{$ENDIF};
...
function    MCIWndCreate(hwndParent: HWND; hInstance: HINST; dwStyle: DWORd; szFile: LPCTSTR): HWND; cdecl;  external VFWDLL
  name {$IFDEF UNICODE}'MCIWndCreateW'{$ELSE}'MCIWndCreateA'{$ENDIF};
...
function    capCreateCaptureWindow(
    ...
    hwndParent          : HWND;
    nID                 : int
    ): HWND; stdcall; external AVICAPDLL name {$IFDEF UNICODE}'capCreateCaptureWindowW'{$ELSE}'capCreateCaptureWindowA'{$ENDIF};
...
function    capGetDriverDescription(
    ...
    lpszVer             : LPTSTR;
    cbVer               : int
    ): BOOL; stdcall; external AVICAPDLL name {$IFDEF UNICODE}'capGetDriverDescriptionW'{$ELSE}'capGetDriverDescriptionA'{$ENDIF};
...
function GetOpenFileNamePreview(lpofn: POpenFilename): BOOL; stdcall; external VFWDLL name {$IFDEF UNICODE}'GetOpenFileNamePreviewW'{$ELSE}'GetOpenFileNamePreviewA'{$ENDIF};
function GetSaveFileNamePreview(lpofn: POpenFilename): BOOL; stdcall; external VFWDLL name {$IFDEF UNICODE}'GetSaveFileNamePreviewW'{$ELSE}'GetSaveFileNamePreviewA'{$ENDIF};
